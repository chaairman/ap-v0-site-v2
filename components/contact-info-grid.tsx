...
export default function ContactInfoGrid() {
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      >
        <MapPin className="h-5 w-5 text-white/80 mb-3" />
      ...
      <motion.div
        ...
        className="bg-blue-500 p-5"
      >
        <Phone className="h-5 w-5 text-white/80 mb-3" />
      ...
      <motion.div
        ...
        className="bg-blue-500 p-5 col-span-2"
      >
        <Mail className="h-5 w-5 text-white/80 mb-3" />
